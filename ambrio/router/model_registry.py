...
DEFAULT_ROUTING: dict[str, str] = {
    "simple":    os.environ.get("AMBRIO_MODEL_SIMPLE",    "ollama/llama3.2-1b"),
    "chat":      os.environ.get("AMBRIO_MODEL_CHAT",      "groq/llama-3.3-70b"),
    "complex":   os.environ.get("AMBRIO_MODEL_COMPLEX",   "gemini/2.5-flash"),
    "code":      os.environ.get("AMBRIO_MODEL_CODE",      "groq/deepseek-r1-70b"),
    "reasoning": os.environ.get("AMBRIO_MODEL_REASONING", "openrouter/deepseek-r1"),
    "vision":    os.environ.get("AMBRIO_MODEL_VISION",    "gemini/2.5-flash"),
    "fast":      os.environ.get("AMBRIO_MODEL_FAST",      "groq/llama-3.1-8b"),
}
