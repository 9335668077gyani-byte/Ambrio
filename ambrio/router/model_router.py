...
_TASK_KW = {
    ...
    "image":  ["convert to pdf", "make pdf", "image to pdf", "combine",
               ...
               "pp size", "passport size", "passport photo", "passport",
               "visa photo", "resize", "rotate", "flip", "background",
               "brighter", "sharper", "enhance", "refine this img",
               "refine the img", "edit image", "edit this image",
               "change size", "make it bigger", "make it smaller"],
